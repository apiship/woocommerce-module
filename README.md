<a href="https://apiship.ru/"><img align="right" width="200" src="logo_gorizont.svg"></a>
...
* WordPress 6.0+ (протестировано с 7.0)
* WooCommerce 8.0+ (протестировано с 10.9)
* PHP 7.4+ (протестировано с 8.1–8.4)
* Поддерживается высокопроизводительное хранилище заказов (HPOS)
* Страница оформления заказа должна использовать классический чекаут — шорткод `[woocommerce_checkout]`. Блочный чекаут (Checkout Blocks) не поддерживается: в нём не отображается выбор пункта выдачи. В новых магазинах WooCommerce создаёт страницу с блочным чекаутом по умолчанию — замените содержимое страницы на шорткод.
